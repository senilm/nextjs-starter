...
const PLANS = [
  ...
  },
  {
    ...
    razorpayPlanId: process.env.RAZORPAY_PRO_MONTHLY_PLAN_ID ?? null,
  ...
  },
  {
    ...
    stripePriceId: process.env.STRIPE_BUSINESS_MONTHLY_PRICE_ID ?? null,
    stripeYearlyPriceId: process.env.STRIPE_BUSINESS_YEARLY_PRICE_ID ?? null,
    razorpayPlanId: process.env.RAZORPAY_BUSINESS_MONTHLY_PLAN_ID ?? null,
    razorpayYearlyPlanId: process.env.RAZORPAY_BUSINESS_YEARLY_PLAN_ID ?? null,
  },
]
