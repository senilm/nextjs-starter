 ...
 * Sidebar component with spring-animated highlight hover system.
 */
...
function SidebarTrigger({ className, onClick, ...props }: SidebarTriggerProps): React.ReactNode {
...
function SidebarRail({ className, ...props }: SidebarRailProps): React.ReactNode {
  const { toggleSidebar } = useSidebar()
...
function SidebarInset({ className, ...props }: SidebarInsetProps): React.ReactNode {
  return (
    <main
...
function SidebarInput({ className, ...props }: SidebarInputProps): React.ReactNode {
  return (
    <Input
...
function SidebarHeader({ className, ...props }: SidebarHeaderProps): React.ReactNode {
  return (
    <div
...
function SidebarFooter({ className, ...props }: SidebarFooterProps): React.ReactNode {
  return (
    <div
...
function SidebarSeparator({ className, ...props }: SidebarSeparatorProps): React.ReactNode {
  return (
    <Separator
...
function SidebarContent({ className, ...props }: SidebarContentProps): React.ReactNode {
  return (
    <div
...
function SidebarGroup({ className, ...props }: SidebarGroupProps): React.ReactNode {
  return (
    <div
...
function SidebarGroupLabel({
  ...
  asChild = false,
  ...props
}: SidebarGroupLabelProps): React.ReactNode {
...
function SidebarGroupAction({
  ...
  asChild = false,
  ...props
}: SidebarGroupActionProps): React.ReactNode {
...
function SidebarGroupContent({
  className,
  ...props
}: SidebarGroupContentProps): React.ReactNode {
  return (
    <div
...
function SidebarMenu({ className, ...props }: SidebarMenuProps): React.ReactNode {
  return (
    <ul
...
function SidebarMenuItem({ className, ...props }: SidebarMenuItemProps): React.ReactNode {
  return (
    <li
...
function SidebarMenuAction({
  ...
  showOnHover = false,
  ...props
}: SidebarMenuActionProps): React.ReactNode {
  const Comp = asChild ? Slot.Root : "button"
...
function SidebarMenuBadge({ className, ...props }: SidebarMenuBadgeProps): React.ReactNode {
  return (
    <div
...
function SidebarMenuSkeleton({
  ...
  showIcon = false,
  ...props
}: SidebarMenuSkeletonProps): React.ReactNode {
...
function SidebarMenuSub({ className, ...props }: SidebarMenuSubProps): React.ReactNode {
  return (
    <ul
...
function SidebarMenuSubItem({ className, ...props }: SidebarMenuSubItemProps): React.ReactNode {
  return (
    <li
...
function SidebarMenuSubButton({
  ...
  className,
  ...props
}: SidebarMenuSubButtonProps): React.ReactNode {
